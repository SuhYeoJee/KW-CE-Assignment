...
public:
    ...
    char** getNameArry(){ return nameArry; }

    void makeGraph(const char* filepath);
    ...
    void UpdateEdge(int startVertexKey, int endVertexKey, float value);
};
